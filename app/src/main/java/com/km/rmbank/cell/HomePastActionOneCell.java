...
public class HomePastActionOneCell extends BaseCell<InformationDto> {

    private Context mContext;

    public HomePastActionOneCell(Context mContext,InformationDto mData) {
        super(mData, R.layout.cell_home_past_action_one);
