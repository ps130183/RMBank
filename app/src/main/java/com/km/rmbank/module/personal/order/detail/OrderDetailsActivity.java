...
import com.km.rmbank.module.personal.order.detail.evaluate.GoodsEvaluateActivity;
...
public class OrderDetailsActivity extends BaseActivity<OrderDetailPresenter> implements OrderDetailContract.View {
    ...
    @Override
    public OrderDetailPresenter getmPresenter() {
    ...
    protected void onCreate() {
        ...
        mPresenter.getOrderDetail(mOrderDto);
    }

    private void loadOrderData(){
        tvShopName.setText(mOrderDto.getShopName());
        GlideUtils.loadImage(ivGoods,mOrderDto.getThumbnailUrl());
                ...
                case 3: //确认收货
                    DialogUtils.showDefaultAlertDialog("是否已经收货？", new DialogUtils.ClickListener() {
                        ...
                        public void clickConfirm() {
                            mPresenter.confirmReceiverGoods(mOrderDto);
                        }
                    });
                    break;
                case 4://去评价
                    ...
                    toNextActivity(GoodsEvaluateActivity.class,bundle);
                    break;
            }
        } else {
            if (mStatus == 2){//发货
                ...
                DialogUtils.showDefaultAlertDialog("是否要发货？", new DialogUtils.ClickListener() {
                    @Override
                    public void clickConfirm() {
                        mPresenter.shopSendGoods(mOrderDto,expressCompany,expressNumber);
                    }
                });
            }
        }
